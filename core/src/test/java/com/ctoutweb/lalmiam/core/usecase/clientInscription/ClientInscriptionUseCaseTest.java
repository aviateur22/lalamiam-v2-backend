...
//    Mockito.when(clientInscriptionRepository.isEmailAvailable(clientInscriptionAdapter.getEmail())).thenReturn(null);
...
//    Mockito.when(clientInscriptionRepository.isEmailAvailable(anyString())).thenReturn(null);
//
//    /**
//     * when
//     */
...
//     * Given
//     */
//    Mockito.when(clientInscriptionRepository.isEmailAvailable(any())).thenReturn(null);
//
//    IBoundaryInputAdapter clientInscriptionAdapter = fakeClientInscriptionAdapter();
//
...
//     * Given
//     */
//    Mockito.when(clientInscriptionRepository.isEmailAvailable(any())).thenReturn((new CreatedClientImpl(1l)));
//
//    IBoundaryInputAdapter clientInscriptionAdapter = fakeClientInscriptionAdapter();
//
//    /**
