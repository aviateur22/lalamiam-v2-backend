...
import static constant.ApplicationConstant.DEFAULT_VALUE_PROFESSIONAL_ACTIVATION_ACCOUNT;
...
//    return new Output(professionalInscriptionResult);
  ...
  public Long createProfessionalAccount(long professionalId) {
    boolean isAccountActif = DEFAULT_VALUE_PROFESSIONAL_ACTIVATION_ACCOUNT;
