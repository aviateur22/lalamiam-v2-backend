...
import provider.IValidateTokenService;
import provider.IProfessionalInscriptionConfirmationRepository;
...
public class ProfessionalInscriptionConfirmationUseCase implements UseCase<ProfessionalInscriptionConfirmationUseCase.Input, ProfessionalInscriptionConfirmationUseCase.Output> {
  ...
  public Output execute(Input input) {
    ...
    IProfessionalConfirmationToken professionalConfirmationToken = findProfessionalConfirmationToken(professional.getProfessionalId());
    ...
    professionalInscriptionConfirmationRepository.confirmProfessionalInscription(professional.getProfessionalId());
   ...
   */
  public IProfessionalConfirmationToken findProfessionalConfirmationToken(Long professionalId) {
    IProfessionalConfirmationToken professionalConfirmationToken = professionalInscriptionConfirmationRepository
