...
import factory.CreateCaptchaImageFactory;
import useCase.UseCase;

import java.awt.*;
import java.awt.image.BufferedImage;

import static constant.ApplicationConstant.CAPTCHA_IMAGE_HEIGHT;
import static constant.ApplicationConstant.CAPTCHA_IMAGE_WIDTH;
...
public class CreateCaptchaImageUseCase implements UseCase<CreateCaptchaImageUseCase.Input, CreateCaptchaImageUseCase.Output> {
  ...
  public Output execute(Input input) {
    ...
    BufferedImage captchaImage = this.generateImage(textToDraw, CAPTCHA_IMAGE_HEIGHT, CAPTCHA_IMAGE_WIDTH);
