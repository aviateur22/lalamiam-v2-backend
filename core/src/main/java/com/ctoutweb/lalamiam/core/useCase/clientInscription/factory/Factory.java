...
public class Factory {
  ...
  public static IClientInscriptionOutput getClientInscriptionOutputImpl(Long clientId, Long accountId, String responseMessage) {
    return new ClientInscriptionOutputImpl(clientId, accountId, responseMessage);
  }
}
